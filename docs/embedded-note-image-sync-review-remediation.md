...
Current status is local final-review remediation pending the final automated
gate, local commit, exact-SHA GitHub Actions, and another independent read-only
review. No XPI has been generated or installed and no production Zotero/Notion
...
Zotero 9.0.6 and Zotero 10 real runtime validation both remain pending. The
first later gate is the generated production-adapter/store smoke script in a
dedicated Zotero 9.0.6 development profile; it was not run in this task.

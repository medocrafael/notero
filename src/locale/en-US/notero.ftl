...
notero-error-note-recovery-required = Notero found an unfinished note transaction that could not be reconciled safely. The last verified note was preserved; restore Notion access or review the recovery record before retrying.
